...
// ORDER HEADER AND FOOTER
    $SQL1 = 
        "SELECT 
            ...
            T0.LicTradeNum, T0.DocDate, T0.DocDueDate, T0.GroupNum, T0.BilltoAddress, T0.ShiptoAddress, T1.SlpName, T0.U_PONo, T0.Comments, 
            T0.DiscPcnt, T0.DiscTotal, T0.DocTotal, T0.VatSum, T0.DocNum AS Title
    ...
    $DocDueDate = date("d/m/Y",strtotime($RST1['DocDueDate']));
    $GroupNum = SapTH($RST_GroupNum['PymntGroup']);
    $BilltoAddress = $RST1['BilltoAddress'];
    $ShiptoAddress = $RST1['ShiptoAddress'];
    ...
    <div class="page">
        ...
        <table class="table table-borderless table-sm m-0" style="color: #000;">
            <thead>
                ...
                <tr>
                    <td colspan="3" class="text-center"><h5 style="margin: 1rem;">ใบสั่งขาย / Sales Order</h5></td>
                </tr>
            </thead>
        </table>
        ...
        <table class="table table-borderless table-sm" style="color: #000;">
            ...
            <tr>
                <th>ที่อยู่จัดส่ง:</th>
                <td colspan='3'><?php echo $ShiptoAddress; ?></td>
            </tr>
            <tr>
                <th>เงื่อนไขการจ่ายเงิน:</th>
                <td colspan='3'><?php echo $GroupNum; ?></td>
            </tr>
        </table>
        ...
        <table class="table QuotationList" style="color: #000;">
            <thead class="text-center">
                <tr>
                    ...
                    <th class='border-dark' scope="col" width="3%">คลัง</th>
            ...
            <tfoot>
                ...
                <tr>
                    ...
                    <td class="border-dark align-top" colspan="4" rowspan="3"><?php echo $Comments; ?></td>
