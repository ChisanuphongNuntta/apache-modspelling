...
include("../../../core/connect.core.php");
include("../../../core/functions.core.php");
include("../../../core/coresap.php");
...
$sql1 = "SELECT * FROM paytax WHERE ID = ".$_GET['id'];
...
<body onload="window.print()">
    ...
    <table width="720px" border="0" cellpadding="0" cellspacing="0" class="bd-sl-t bd-sl-r bd-sl-b bd-sl-l">
        <tr>
            ...
            <td class="text-center">0105545012035</td>
            <td>สำนักงานใหญ่</td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td class="text-right">ชื่อ</td>
            <td colspan="4">บริษัท คิงบางกอก อินเตอร์เทรด จำกัด</td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td class="text-right">ที่อยุ่</td>
            <td colspan="4">541,543,545 ซอย 39/1 ถ. รามอินทรา แขวงท่าแร้ง เขตบางเขน กรุงเทพฯ 10220</td>
        </tr>
        <tr>
            <td colspan="2" width="22.5%">ผู้ถูกหักภาษี ณ ที่จ่าย:</td>
            <td class="text-right">เลขที่ประจำตัวผู้เสียภาษี</td>
            <td class="text-center">0115565022583</td>
            <td>สำนักงานใหญ่</td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td class="text-right">ชื่อ</td>
            <td colspan="4">บจก. ฮาร์ดแวร์เฮาส์ คอร์ปอเรชั่น </td> <!-- หยอด -->
        </tr>
        <tr class="bd-sl-b">
            <td>&nbsp;</td>
            <td class="text-right">ที่อยุ่</td>
            <td colspan="4">89/9 หมู่ 7 ถนนเทพรัตน กม.25 ตำบลบางเสาธง อำเภอบางเสาธง จังหวัดสมุทรปราการ 10570 </td> <!-- หยอด -->
        </tr>
    </table>
    <table width="720px" border="0" cellpadding="4" cellspacing="0" class="detail bd-sl-r bd-sl-b bd-sl-l">
        <tr>
            ...
            <td style="padding-left: 3rem;" class="bd-sl-b" width="55%">
                ...
                <span>ค่าส่งเสริมการขาย</span> <!-- หยอด -->
            </td>
        ...
        <tr>
            ...
            <td class="text-center" valign="top"></td> <!-- หยอด -->
            <td class="text-right" valign="top"></td> <!-- หยอด -->
            <td class="text-right" valign="top"></td> <!-- หยอด -->
        </tr>
        <!-- 4ข2 2.3 -->
        <tr>
        ...
        <tr>
            <td style="padding-left: 1rem;" class="bd-sl-b">6. อื่น ๆ (ระบุ) ค่าส่งเสริมการขาย</td><!-- หยอด -->
            <td class="text-center bd-sl-b">16/11/2565</td> <!-- หยอด -->
            <td class="text-right bd-sl-b">28,899.11</td> <!-- หยอด -->
            <td class="text-right bd-sl-b">866.97</td> <!-- หยอด -->
        </tr>
        ...
        <tr style="font-weight: bold;">
            ...
            <td class="text-center">&nbsp;</td> <!-- หยอด -->
            <td class="text-right">28,899.11</td> <!-- หยอด -->
            <td class="text-right">866.97</td> <!-- หยอด -->
        </tr>
        <tr>
            <td style="padding-left: 1rem;" colspan="4">รวมเงินภาษีที่หักนำส่ง (แปดร้อยหกสิบหกบาทเก้าสิบเจ็ดสตางค์).</td><!-- หยอดในวงเล็บ -->
        </tr>
    </table>
    <table width="720px" border="0" cellpadding="4" cellspacing="0" class="bd-sl-r bd-sl-b bd-sl-l">
        <tr>
            ...
            <td class="text-center" style="font-size: 22px;">&#9746;</td><!-- หยอด -->
    ...
    <table width="720px" border="0" cellpadding="4" cellspacing="0" class="detail bd-sl-r bd-sl-b bd-sl-l">
        ...
        <tr>
            ...
            <td class="text-center">..........................................<br/>16/11/2565</td><!-- หยอด -->
