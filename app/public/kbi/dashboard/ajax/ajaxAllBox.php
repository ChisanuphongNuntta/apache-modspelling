        ...
        foreach($TeamArr as $Team) {
            ...
            while($RST1 = mysqli_fetch_array($QRY1)) {
                ...
                if($RST1['DocStatus'] == 'A') {
                    ...
                    if($SlpCode['SlpCode'] == '23' OR $SlpCode['SlpCode'] == '24' OR $SlpCode['SlpCode'] == '158' OR $SlpCode['SlpCode'] == '406' OR $SlpCode['SlpCode'] == '416' OR $SlpCode['SlpCode'] == '417' OR $SlpCode['SlpCode'] == '418' ) {
                        switch ($SlpCode['SlpCode']) {
                            case '23': 
                            case '416': $Name = "โฮมโปร-ฝากขาย"; break;
                            case '24':
                            case '417' : $Name = "ไทวัสดุ-ฝากขาย"; break;
                            case '158': $Name = "เกศศินี ฝากขาย เมกาโฮม"; break;
                            case '418' : $Name = "เมกาโฮม-ฝากขาย"; break;
