...
/* เพิ่มสคลิป อื่นๆ ต่อจากตรงนี้ */
    ...
    function CallData() {
        ...
        if(CardCode != "") {
            $.ajax({
                url: "menus/account/ajax/ajaxbillingnote.php?a=CallData",
                type: "POST",
    ...
    function chkRow(TransID,Remark,LineNum) {
        ...
        $.ajax({
            url: "menus/account/ajax/ajaxbillingnote.php?a=AddData",
            type: "POST",
            data: { Chk      : Chk,
                    TransID  : TransID,
                    IVRemark   : Remark,
    ...
    function CallBI(TransID,LineNum) {
        $.ajax({
            url: "menus/account/ajax/ajaxbillingnote.php?a=CallBI",
            type: "POST",
    ...
    function Save() {
        $.ajax({
            url: "menus/account/ajax/ajaxbillingnote.php?a=Save",
            type: "POST",
    ...
    function Print() {
        ...
        window.open ('menus/account/print/printBill.php?docnum='+DocNum,'_blank');
        CallData();
    }
</script> 