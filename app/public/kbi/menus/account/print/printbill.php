...
<table border=0 cellpadding=0 cellspacing=0 width=809 style='border-collapse:collapse;table-layout:fixed;width:608pt; margin: 0 auto;'>
 ...
 <?php
  ...
  $sql1 ="SELECT * FROM  note_billing WHERE DocNum = '".$billData."' AND DocStatus = 'A'";
...
//ดึงบิล
  ...
  $sql2 = "SELECT P0.* 
              ...
              FROM JDT1 T0
              WHERE T0.Account = '1121-01' AND (T0.[TransType] = '13' OR T0.[TransType] = '14' OR T0.[TransType] = '30') 
...
$CountBill = $CountBill-1;
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td colspan=12 rowspan=2 class=xl96>บริษัท คิงบางกอก อินเตอร์เทรด จำกัด</td>
  <td></td>
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 style='height:15.0pt'></td>
  <td colspan=12 class=xl98>541,543,545 ซอย 39/1 ถนนรามอินทรา (กม4.)
 ...
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  </span>10220 TEL. 02-509-3850 FAX.02-509-3856</td>
  <td colspan=4 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 style='height:15.0pt'></td>
  <td colspan=12 class=xl98>เลขประจำตัวผู้เสียภาษี 0105545012035</td>
  <td colspan=4 style='mso-ignore:colspan'></td>
 </tr>
...
<?php
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  ห้ามจ่ายเป็นเงินสด โปรดจ่ายเป็นเช็คขีดคร่อม ในนาม บริษัท คิงบางกอก
