...
if($_SESSION['UserName'] == NULL){
    ...
    if(!isset($_GET['u'])) {
        ...
        switch($ukey) {
            ...
            case "B98": $PrintName = "ซ่อมภายนอก (QC)"; break;
            case "B99": $PrintName = "ซ่อมภายใน"; break;
            case "PITA": $PrintName = "พีต้า อินเตอร์เทรด"; break;
            default:
                                ...
                                <td>
                                    ...
                                    <table class="table table-borderless table-sm" style="color: #000;">
                                        <thead>
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <strong>พนักงานขาย:</strong> <?php echo $PrintName; ?><br/>
                            ...
                            <tr>
                                <td>
                                    <table class="table table-bordered table-sm OrderList border-dark" style="color: #000;">
                                        ...
                                        <?php
                                            switch($ukey) {
                                                case "B60": $RptWhr = "AND (T0.SlpCode = 251)"; break;
                                                case "B98": $RptWhr = "AND (T0.SlpCode = 296)"; break;
                                                case "B99": $RptWhr = "AND (T0.SlpCode = 291)"; break;
                                                case "PITA": $RptWhr = ""; break;
                                                default: $RptWhr = "AND (T1.Memo = '$ukey' OR (T0.SlpCode IN (251,291,296) AND T3.Memo = '$ukey'))"; break;
                                            }
                                            ...
                                            $ReportSQL = "SELECT
                                                        ...
                                                        WHERE T1.SlpName NOT LIKE '%.3%' AND 
                                                            ...
                                                            (T0.DocStatus = 'O' AND (T0.DocTotal-T0.PaidToDate) > 0) $RptWhr
                                                        UNION ALL
                                                        SELECT
                                            ...
                                            // echo $ReportSQL;
                                            if($pta == TRUE){
                                                $ReportQRY = PITASelect($ReportSQL);
                                            }else{
