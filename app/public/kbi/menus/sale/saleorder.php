...
<style type="text/css">
    ...
    .txtFirstNum input::-webkit-outer-spin-button,input::-webkit-inner-spin-button {
        -webkit-appearance: none;
        margin: 0;
    }
    .txtSumNum input::-webkit-outer-spin-button,input::-webkit-inner-spin-button {
        -webkit-appearance: none;
        margin: 0;
    }
    .form-ItemCode .form-check-input:disabled~.form-check-label, .form-check-input[disabled]~.form-check-label {
        opacity: 1;
    }
    .form-ItemCode .form-check-input:disabled {
        opacity: 1;
    }
    .form-BarCode .form-check-input:disabled~.form-check-label, .form-check-input[disabled]~.form-check-label {
        opacity: 1;
    }
    .form-BarCode .form-check-input:disabled {
        opacity: 1;
    }
</style>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="OrderList" role="tabpanel" aria-labelledby="OrderList-tab">
                            ...
                            <div class="col-lg-2 col-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-select form-select-sm" name="filt_team" id="filt_team">
                                        ...
                                        <option value="DMN"<?php echo $opt_DMN; ?>><?php echo SATeamName("DMN"); ?></option>
                        ...
                        <div class="table-responsive" style="min-height: 512px;">
                            <table class="table table-sm table-hover table-bordered" id="OrderListTable" style="font-size: 12px;">
                                <thead>
                                    <tr>
                                        <th class="text-center border-top" width="3.5%">ลำดับ</th>
                                        <th class="text-center border-top" width="6.5%">วันที่<br/>เอกสาร</th>
                                        <th class="text-center border-top" width="6.5%">วันที่<br/>กำหนดส่ง</th>
                                        ...
                                        <th class="text-center border-top" width="6.5%">ยอดขาย</th>
                                        ...
                                        <th class="text-center border-top" width="7.5%">SAP S/O No.</th>
                        ...
                        <form class="form" id="OrderForm" enctype="multipart/form-data">
                            ...
                            <div id="order-step1" class="need-validation" data-step="1">
                                ...
                                <div class="row mt-4">
                                    <div class="col-lg-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control" name="CardCode" id="CardCode" data-live-search="true" data-size="10" aria-placeholder="กรุณาเลือกลูกค้า" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="Date" class="form-control" name="DocDate" id="DocDate" value="<?php echo date("Y-m-d"); ?>" disabled required />
                                        </div>
                                    </div>
                                    <div class="col-lg col-sm-6">
                                        <div class="form-group mb-3">
                                            <label for="DocDueDate">วันที่กำหนดส่ง</label>
                                            <input type="Date" class="form-control" name="DocDueDate" id="DocDueDate" value="<?php echo Next3Day(date("Y-m-d")); ?>" disabled />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="form-group mb-3">
                                            <label for="ShipCostType">รูปแบบชำระค่าขนส่ง<span class="text-danger">*</span></label>
                                            <select class="form-select" name="ShipCostType" id="ShipCostType" disabled>
                                                <option value="" selected>กรุณาเลือกรูปแบบค่าขนส่ง</option>
                                                <option value="PRE">บริษัทจ่ายค่าขนส่งต้นทาง</option>
                                                <option value="PST">ลูกค้าจ่ายเงินค่าขนส่งปลายทาง</option>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        <td colspan="7" rowspan="5" style="vertical-align: top;">
                                                            <textarea class="form-control" id="DocRemark" name="DocRemark" rows="8" maxlength="254" placeholder="ระบุหมายเหตุ (ไม่เกิน 250 ตัวอักษร)"></textarea>
                                                        </td>
...
<div class="modal fade" id="ModalAddItem" tabindex="-1" role="dialog" data-bs-backdrop="static" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-body">
            ...
            <div class="row mt-4">
                <div class="col-lg">
                    <h5><i class="fas fa-warehouse fa-fw fa-1x"></i> โควต้าสินค้า</h5>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-lg" id="QuotaItem"></div>
            </div>
            <div class="row mt-2">
                <div class="col-lg">
                    <div class="form-group mb-3">
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-body">
            ...
            <ul class="nav nav-tabs" id="main-tabs" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <?php $Dis = ($_SESSION['uClass'] == 0)? "" : "disabled"; ?>
                    <a href="javascript:void(0);" class="btn-tabs nav-link" id="ImportExcel-tab" data-bs-toggle="tab" data-bs-target="#ImportExcel" role="tab" data-tabs="1" aria-controls="ImportExcel" aria-selected="true">
            ...
            <div class="tab-content">
                ...
                <!-- TAB 1 -->
                <div class="tab-pane fade" id="ImportExcel" role="tabpanel" aria-labelledby="ImportExcel-tab">
                    <form class="form" id="FormImportExcel" enctype="multipart/form-data"> 
                        <div class="row pt-3">
                            <div class="col-auto">
                                <div class="form-group">
                                    <label for="txtFile"><i class="fas fa-file-excel fa-fw fa-1x"></i> ไฟล์นำเข้า</label>
                                    <input type="file" class='form-control form-control-sm' name='txtFile' id='txtFile' accept=".xls,.xlsx">
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="form-group txtFirstNum">
                                    <label for="txtFirstNum">บรรทัดเริ่มต้น</label>
                                    <input type="number" class='form-control form-control-sm text-center' name='txtFirstNum' id='txtFirstNum' min='1' value='1'>
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="form-group txtSumNum">
                                    <label for="txtSumNum">จำนวนรายการ <small class='text-muted'>ได้สูงสุด 120 รายการ</small></label>
                                    <input type="number" class='form-control form-control-sm text-center' name='txtSumNum' id='txtSumNum' min='1' max='120' value='1'>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-check d-flex form-ItemCode align-items-center">
                                    <input type="checkbox" class='form-check-input' name='txtChkItemCode' id='txtChkItemCode' onclick="ChkItem('ItemCode')">
                                    <label class='form-check-label ps-1' for="txtChkItemCode" style='width: 12%;'>รหัสสินค้า</label>
                                    <input type="text" class='form-control form-control-sm text-center w-auto' name='txtItemCode' id='txtItemCode' placeholder='กรอกคอลัมน์เซลล์' readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row pt-2">
                            <div class="col">
                                <div class="form-check d-flex form-BarCode align-items-center">
                                    <input type="checkbox" class='form-check-input' name='txtChkBarCode' id='txtChkBarCode' onclick="ChkItem('BarCode')">
                                    <label class='form-check-label ps-1' for="txtChkBarCode" style='width: 12%;'>บาร์โค้ด</label>
                                    <input type="text" class='form-control form-control-sm text-center w-auto' name='txtBarCode' id='txtBarCode' placeholder='กรอกคอลัมน์เซลล์' readonly>
                                </div>
                            </div>
                        </div>
                        <hr class='mt-2 mb-2 border'>
                        <div class="row">
                            <div class="col">
                                <div class="form-check d-flex align-items-center">
                                    <input type="checkbox" class='form-check-input' name='txtChkQuantity' id='txtChkQuantity' onclick="ChkItem('Quantity')">
                                    <label class='form-check-label ps-1' for="txtChkQuantity" style='width: 12%;'>จำนวน</label>
                                    <input type="text" class='form-control form-control-sm text-center w-auto' name='txtQuantity' id='txtQuantity' placeholder='กรอกคอลัมน์เซลล์' readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row pt-2">
                            <div class="col">
                                <div class="form-check d-flex align-items-center">
                                    <input type="checkbox" class='form-check-input' name='txtChkDiscount' id='txtChkDiscount' onclick="ChkItem('Discount')">
                                    <label class='form-check-label ps-1' for="txtChkDiscount" style='width: 12%;'>ส่วนลด</label>
                                    <input type="text" class='form-control form-control-sm text-center w-auto' name='txtDiscount' id='txtDiscount' placeholder='กรอกคอลัมน์เซลล์' readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row pt-2">
                            <div class="col">
                                <div class="form-check d-flex align-items-center">
                                    <input type="checkbox" class='form-check-input' name='txtChkPrice' id='txtChkPrice' onclick="ChkItem('Price')">
                                    <label class='form-check-label ps-1' for="txtChkPrice" style='width: 12%;'>ราคา/หน่วย</label>
                                    <input type="text" class='form-control form-control-sm text-center w-auto' name='txtPrice' id='txtPrice' placeholder='กรอกคอลัมน์เซลล์' readonly>
                                </div>
                            </div>
                        </div>
                    </form>
                    <div class="row pt-2">
                        <div class="col text-center">
                            <input type="hidden" name='tmpMulti' id='tmpMulti' readonly>
                            <button type="button" class="btn btn-sm btn-primary btn-ImportExcel" onclick='ImportExcel()'><i class="fas fa-file-import"></i> นำเข้า</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-full modal-dialog-scrollable">
        ...
        <div class="modal-body">
            ...
            <ul class="nav nav-tabs" id="so-tabs" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a href="#SOAttachList" class="btn btn-tabs nav-link" id="SOAttachTab" data-bs-toggle="tab" data-bs-target="#SOAttachList" role="tab" data-tabs="2" aria-controls="SOAttachList" aria-selected="true" style="font-size: 12px;">
                        <i class="fas fa-paperclip fa-fw fa-1x"></i> เอกสารแนบ
                    </a>
                </li>
                <li class="nav-item" role="presentation">
                    <a href="#SOApproveList" class="btn btn-tabs nav-link disabled" id="SOApproveTab" data-bs-toggle="tab" data-bs-target="#SOApproveList" role="tab" data-tabs="3" aria-controls="SOApproveList" aria-selected="true" style="font-size: 12px;">
                        <i class="fas fa-tasks fa-fw fa-1x"></i> สถานะการอนุมัติ
                    </a>
                </li>
                <li class="nav-item" role="presentation">
                    <a href="#SOAppCredit" class="btn btn-tabs nav-link disabled" id="SOAppCreditTab" data-bs-toggle="tab" data-bs-target="#SOAppCredit" role="tab" data-tabs="4" aria-controls="SOAppCredit" aria-selected="true" style="font-size: 12px;">
                        <i class="fas fa-tasks fa-fw fa-1x"></i> พิจารณาขายเกินวงเงิน
                    </a>
                </li>
                <li class="nav-item" role="presentation">
                    <a href="#SOAppGP" class="btn btn-tabs nav-link disabled" id="SOAppGPTab" data-bs-toggle="tab" data-bs-target="#SOAppGP" role="tab" data-tabs="5" aria-controls="SOAppGP" aria-selected="true" style="font-size: 12px;">
                        <i class="fas fa-tasks fa-fw fa-1x"></i> พิจารณาขายราคาพิเศษ
                    </a>
                </li>
            </ul>
            <!-- CONTENT TAB -->
            <div class="tab-content">
                ...
                <div class="tab-pane" id="SOAppCredit" role="tabpanel" aria-labelledby="SOAppCreditTab">
                    <div class="row mt-4">
                        <div class="col-12">
                            <table class="table table-bordered" style="font-size: 12px;">
                                <thead class="text-center">
                                ...
                                <tbody id="soview_approveCredit"></tbody>
                            </table>
                        </div>
                    </div>
                </div>
                <div class="tab-pane" id="SOAppGP" role="tabpanel" aria-labelledby="SOAppGPTab">
                    <div class="row mt-4">
                        <div class="col-12">
                            <table class="table table-bordered" style="font-size: 12px;">
                                <thead class="text-center">
                                    <tr>
                                        ...
                                        <th width="6%">ราคาต่อชิ้น<br/>(บาท) (VAT)</th>
                                        <th width="6%">ราคารวม<br/>(บาท) (VAT)</th>
                                        <th width="6%">กำไรรวม<br/>(VAT)</th>
                                        <th width="5%">%<br/>กำไร</th>
                                        <th width="6%">ขายเข้า MT<br/>ล่าสุด (บาท)</th>
                                        <th width="6%">หน้าขาย MT<br/>(บาท)</th>
                                    </tr>
                                </thead>
                                <tbody id="soview_approveGP"></tbody>
                            </table>
                        </div>
                    </div>
                </div>
...
function GETList(filt_year,filt_month,filt_team) {
    ...
    $("#OrderListTable").dataTable().fnDraw();
    $("#OrderListTable").dataTable().fnDestroy();
    ...
    $("#OrderListTable").DataTable({
        ...
        "columns": [
            ...
            { "data": "DocumentNo", class: "text-center border-start border-bottom" },
            { "data": "CardInfo", class: "border-start border-bottom" },
            { "data": "U_PONo", class: "border-start border-bottom" },
            { "data": "DocTotal", class: "text-right border-start border-bottom" },
            { "data": "MainTeam", class: "border-start border-bottom" },
            { "data": "txt_status", class: "text-center border-start border-bottom" },
            { "data": "SAPDocNum", class: "text-center border-start border-bottom" },
...
function CheckForm(StepNow,StepTo) {
    ...
    switch(Now) {
        case "1": CheckID = ["CardCode", "AddressBillTo", "AddressShipto", "TaxType", "PaymentTerm", "DocDate", "SlpCode", "DocType", "ShipCostType"]; break;
...
function AddItem() {
    $("#AddItem").on("click", function(e) {
        ...
        $("#ItemWhse").empty();
        $("#ItemHistory, #QuotaItem").html("<p class=\"text-center text-muted\">กรุณาเลือกสินค้า และกรอกจำนวน</p>");
        ...
        success: function(result) {
            ...
            $.each(obj,function(key,inval) {
                if(inval['Rows'] == 0) {
                    ...
                    for(i = 0; i < parseFloat(inval['Rows']); i++) {
                        RowID++;
                        console.log(i+"-"+inval[i]['GrandPrice']);
                        ...
                        SumItemList.push(RowID);
                        var No = SumItemList.length;

                        NewRow += "<tr data-rowid='"+RowID+"'>"+
                            "<td class='text-center' id='NoItemList_"+RowID+"'>"+No+"</td>"+
        ...
        success: function(result){
            ...
            $.each(obj,function(key,inval){
                ...
                switch(uClass) {
                    ...
                    case "18":
                    case "19":
                    case "20": var ValDisabled = ["00","ACC","AGT","IMAX","JSI","KB9","KS","KSM","KTW","NST","PLA","PU","RST","RTR","SY","TC","TT-ขาย","VRK","W",,"YEE","YMT"]; break;
...
function AddNewRow() {
    ...
    // var rowCount = $('#ItemListData tr').length;
    ...
    if (ItemCode == null || GrandPrice.length == 0 || (ItemQuantity.length == 0 || ItemQuantity < 1) || ItemWhse == null){
        ...
        if (EditRow == "0") {
            ...
            SumItemList.push(RowID);
            var No = SumItemList.length;
            let temMulti = ($("#tmpMulti").val() == 'Y') ? "table-danger" : "";
            var NewRow = "<tr class='"+temMulti+"' data-rowid='"+RowID+"'>"+
                            "<td class='text-center' id='NoItemList_"+RowID+"'>"+No+"</td>"+
            ...
            $("#tmpMulti").val(""); // ล้างค่า Multi ImportExcel
        }else{
...
function DeleteItem (row) {
    ...
    $("#btn-del-confirm").on("click",function(e){
        ...
        SumItemList = jQuery.grep(SumItemList, function(value) {
            return value != parseInt(RowID);
        });
        for (var i = 0; i < SumItemList.length; i++){
            $("#NoItemList_"+SumItemList[i]).html(i+1);
        }
...
function GetDocTotal() {
    ...
    if(parseFloat(DiscountSum) > TotalPrice) {
        ...
        $("#ProfitTotal").val(number_format((DocTotal-TotalCxst),3));
    }
}
...
function PreviewSO(DocEntry,int_status) {
    ...
    switch(int_status) {
        case 2: $("#SOApproveTab, #SOAppCreditTab, #SOAppGPTab").removeClass("disabled"); break;
        default: $("#SOApproveTab").addClass("disabled"); break;
    }
    $("#SOApproveTab, #SOAppCreditTab, #SOAppGPTab").removeClass("disabled");
...
$("#CardCode").on("change", function() {
    ...
    $.ajax({
        ...
        success: function(result){
            ...
            $.each(obj,function(key,inval) {
                ...
                $("#ShippingType").selectpicker("destroy").val(ShippingType).change().selectpicker(); 
    ...
    if(DeptCode == "DP006" || DeptCode == "DP007") {
...
$("#ImportItem").on("click",function(e){
    e.preventDefault();
    let myinput = [].slice.call(
        document.querySelectorAll("#ImportSearchInput, #txtFile, #txtFirstNum, #txtSumNum, #txtItemCode, #txtBarCode, #txtQuantity, #txtDiscount, #txtPrice")
    );
    myinput.forEach(input => {
        input.value = input.defaultValue;
    });
    $(".btn-ImportExcel").prop('disabled',false);
    $("#txtItemCode, #txtBarCode, #txtQuantity, #txtDiscount, #txtPrice").prop("readonly",true);
    $("#txtChkItemCode, #txtChkBarCode, #txtChkQuantity, #txtChkDiscount, #txtChkPrice").prop("checked",false);
...
$("#btn-searchdoc").on("click", function(e){
    ...
    if(SearchBox.length == 0) {
        $("#alert_header").html("<i class=\"far fa-times-circle fa-fw fa-lg text-danger\"></i> พบข้อผิดพลาด!");
        $("#alert_body").html("กรุณากรอกเลขที่เอกสารก่อนกดค้นหา");GrandPrice
        $("#alert_modal").modal('show');
    } else {
...
function PrintSB(x) {
    window.open ('menus/sale/print/printpickso.php?docety='+x,'_blank');
}

function ChkItem(x) {
    switch (x) {
        case 'ItemCode':
            $("#txtChkItemCode").prop("disabled",true);
            $("#txtItemCode").prop("readonly",false);
            $("#txtChkBarCode").prop("checked",false).prop("disabled",false);
            $("#txtBarCode").val("").prop("readonly",true);
        break;
        case 'BarCode':
            $("#txtChkBarCode").prop("disabled",true);
            $("#txtBarCode").prop("readonly",false);
            $("#txtChkItemCode").prop("checked",false).prop("disabled",false);
            $("#txtItemCode").val("").prop("readonly",true);
        break;
        case 'Quantity':
            if($("#txtChkQuantity").is(":checked")) {
                $("#txtQuantity").val("").prop("readonly",false);
            }else{
                $("#txtQuantity").val("").prop("readonly",true);
            }
        break;
        case 'Discount':
            if($("#txtChkDiscount").is(":checked")) {
                $("#txtDiscount").val("").prop("readonly",false);
            }else{
                $("#txtDiscount").val("").prop("readonly",true);
            }
        break;
        case 'Price':
            if($("#txtChkPrice").is(":checked")) {
                $("#txtPrice").prop("readonly",false);
            }else{
                $("#txtPrice").val("").prop("readonly",true);
            }
        break;
    }
}

$("#txtFirstNum").on("focusout", function(e) {
    e.preventDefault();
    if($(this).val() <= 0) {
        $(this).val(1);
    }
...
$("#txtSumNum").on("focusout", function(e) {
    e.preventDefault();
    if($(this).val() > 120) {
        $(this).val(120);
    }else{
...
function ImportExcel() {
    let FormImportExcel = new FormData($("#FormImportExcel")[0]);

    if($("#txtFile").val() == "") { 
        $("#alert_header").html("<i class=\"far fa-times-circle fa-fw fa-lg text-danger\"></i> พบข้อผิดพลาด!");
        $("#alert_body").html("กรุณาแนบไฟล์นำเข้าก่อน");
        $("#alert_modal").modal('show');
        return; 
    }

    if($("#txtChkItemCode").is(":checked") == true && $("#txtItemCode").val() == '') { 
        $("#alert_header").html("<i class=\"far fa-times-circle fa-fw fa-lg text-danger\"></i> พบข้อผิดพลาด!");
        $("#alert_body").html("กรุณากรอกคอลัมน์เซลล์ รหัสสินค้า");
        $("#alert_modal").modal('show');
        return; 
    }

    if($("#txtChkBarCode").is(":checked") == true && $("#txtBarCode").val() == '') { 
        $("#alert_header").html("<i class=\"far fa-times-circle fa-fw fa-lg text-danger\"></i> พบข้อผิดพลาด!");
        $("#alert_body").html("กรุณากรอกคอลัมน์เซลล์ บาร์โค้ด");
        $("#alert_modal").modal('show');
        return; 
    }

    if($("#txtChkQuantity").is(":checked") == true && $("#txtQuantity").val() == '') { 
        $("#alert_header").html("<i class=\"far fa-times-circle fa-fw fa-lg text-danger\"></i> พบข้อผิดพลาด!");
        $("#alert_body").html("กรุณากรอกคอลัมน์เซลล์ จำนวน");
        $("#alert_modal").modal('show');
        return; 
    }

    if($("#txtChkDiscount").is(":checked") == true && $("#txtDiscount").val() == '') { 
        $("#alert_header").html("<i class=\"far fa-times-circle fa-fw fa-lg text-danger\"></i> พบข้อผิดพลาด!");
        $("#alert_body").html("กรุณากรอกคอลัมน์เซลล์ ส่วนลด");
        $("#alert_modal").modal('show');
        return; 
    }

    if($("#txtChkPrice").is(":checked") == true && $("#txtPrice").val() == '') { 
        $("#alert_header").html("<i class=\"far fa-times-circle fa-fw fa-lg text-danger\"></i> พบข้อผิดพลาด!");
        $("#alert_body").html("กรุณากรอกคอลัมน์เซลล์ ราคา");
        $("#alert_modal").modal('show');
        return; 
    }
    
    if($("#txtChkItemCode").is(":checked") != true && $("#txtChkBarCode").is(":checked") != true) {
        $("#alert_header").html("<i class=\"far fa-times-circle fa-fw fa-lg text-danger\"></i> พบข้อผิดพลาด!");
        $("#alert_body").html("กรุณาเลือกรหัสสินค้าหรือบาร์โค้ดก่อน");
        $("#alert_modal").modal('show');
        return; 
    }
    ...
    $(".btn-ImportExcel").prop('disabled',true);
    $(".overlay").show();
    $.ajax({
        url: "menus/sale/ajax/ajaxsaleorder.php?p=ImportExcel",
        type: 'POST',
        dataType: 'text',
        cache: false,
        processData: false,
        contentType: false,
        data: FormImportExcel,
        async: false,
        success: function(result) {
            let obj = jQuery.parseJSON(result);
            $.each(obj,function(key,inval) {
                if(inval['Error']['BarCode'] == "" && inval['Error']['ItemCode'] == 0) {
                    $.each(inval['Data'], function(k,data) {
                        let Quantity = (typeof(data['Quantity']) == 'undefined') ? 1 : data['Quantity'];
                        let Discount = (typeof(data['Discount']) == 'undefined') ? "" : data['Discount'];
                        let Price = (typeof(data['Price']) == 'undefined') ? "" : data['Price'];
                        GetItemDetailImPort(CardCode,data['ItemCode'],Quantity,Discount,Price,data['Multi']);
                    });
                    $("#ModalImport").modal("hide");
                }else{
                    $(".btn-ImportExcel").prop('disabled',false);
                    if(inval['Error']['BarCode'] != "") {
                        $("#alert_header").html("<i class=\"far fa-times-circle fa-fw fa-lg text-danger\"></i> พบข้อผิดพลาด!");
                        $("#alert_body").html("ไม่มีบาร์โค้ดนี้ในระบบ<br>รายการที่ "+inval['Error']['BarCode']);
                        $("#alert_modal").modal('show');
                    }else{
                        $("#alert_header").html("<i class=\"far fa-times-circle fa-fw fa-lg text-danger\"></i> พบข้อผิดพลาด!");
                        $("#alert_body").html("ไม่มีรหัสสินค้านี้ในระบบ<br>รายการที่ "+inval['Error']['ItemCode']);
                        $("#alert_modal").modal('show');
                    }
...
function GetItemDetailImPort(CardCode,ItemCode,Quantity,Discount,Price,Multi) {
    $(".overlay").show();
    var SelectOption = $("#ItemSelect").html();
    $("#RowID").val(0);
    $("#ItemSelect").empty().selectpicker('destroy');
    ...
    $.ajax({
        ...
        success: function(result){
            var obj = jQuery.parseJSON(result);
            $.each(obj,function(key,inval){
                $("#ItemSelect").val(ItemCode).change().selectpicker();
                ...
                $("#PriceAfDisc, #Chk_DefaultPrice").val(DefaultPrice);
                if(Price != "") {
                    $("#GrandPrice").val(Price);
                }else{
                    $("#GrandPrice").val(DefaultPrice);
                }
                $("#Discount").val(Discount);
                $("#chk_price").prop('checked',false).removeAttr("readonly disabled");
                $("#Chk_CXST").val(inval['CXST']);
